...
<body>
    ...
    <section class="gridSection">
        <div class="sectionDesc aboutusDesc">
            ...
            <p class="sub-headline">
                The company has been trading cryptocurrency since 2009, it has boasted impressive numbers over the years
                as shown below:
            </p>
        </div>
    ...
    <div class="statusContainer">
        <div class="status">
            <h1><b>3600+</b> Clients</h1>
            <p>over 3600+ clients and counting use Zenith Holdings.</p>
        </div>

        <div class="status">
            <h1><b>150+</b> Projects</h1>
            <p>Over the years we have completed more than 150 projects.</p>
        </div>

        <div class="status">
            <h1><b>40+</b> Countries</h1>
            <p>Countries spanning across Europe,Africa and North America.</p>
        </div>
    </div>
    ...
    <section class="videoSection">
        <h1 class="videoSectionHeader">Play Video</h1>
        <div class="videoContainer">
            ...
            <p>
                Crypto mining has become more popular with people from all walks of life and across the world. This
                article will teach you how to mine crypto without having to buy expensive hardware or pay exorbitant
                electricity bills.
            </p>
        </div>
    </section>
    ...
    <footer>
        ...
        <div class="footerlinksContainer">
            <div class="footerAboutus">
                <img class="img_size" src="./img/logo-white.png" alt="">
                <p class="darkPara">With no commissions and a simple user interface, Prouple is the most reliable way to
        ...
        <div class="footerCopyright">
            <p>&copy; 2024 design and developed by
                <a href="#" class="developedBy">Ericcy@20</a>.
            </p>
        </div>
    </footer>
